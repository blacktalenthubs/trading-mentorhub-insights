...
export function setupBlurb(alertType?: string): string {
  ...
  const BLURB: Record<string, string> = {
    ...
    orb_break: "Broke and held above the opening range — momentum continuation.",
    orb_held: "Tested the opening-range level and held it — support.",
    orb_retest: "Broke the opening range, retested the rail, and held — continuation.",
