...
export function setupBlurb(alertType?: string): string {
  ...
  const BLURB: Record<string, string> = {
    ...
    pdh_held: "Broke above yesterday's high, pulled back to it and held — strength (the hold, not the break).",
    pdl_held: "Held above yesterday's low as support — dipped to it and held.",
    orb_high_held: "Broke the 1h opening-range high, retested it and held — strength.",
    orb_low_held: "Held above the 1h opening-range low as support.",
