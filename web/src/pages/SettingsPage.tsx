...
import {
  ...
  Sun, Moon, Zap, ShieldCheck, X, Plus, TrendingDown,
  Target,
} from "lucide-react";
      ...
      <div className="max-w-5xl mx-auto space-y-4">
        ...
        <div className="flex flex-col gap-5 md:flex-row md:items-start">
          ...
          <div className="min-w-0 flex-1 space-y-5">
            {pane === "alerts" && (<><MarketGateSection /><AlertTypesSection /><ShortAllowlistSection /><OrbUserAllowlistSection /></>)}
