...
_SETUP_NAMES: dict[str, str] = {
    ...
    "ma20_support_4h": "20 SMA (4h) support",
    "ma50_support_4h": "50 SMA (4h) support",
    "ma200_support_4h": "200 SMA (4h) support",
    "ma20_reject_1h": "20 SMA (1h) rejection",
    "ma50_reject_1h": "50 SMA (1h) rejection",
    "ma200_reject_1h": "200 SMA (1h) rejection",
    "ma20_reject_4h": "20 SMA (4h) rejection",
    "ma50_reject_4h": "50 SMA (4h) rejection",
    "ma200_reject_4h": "200 SMA (4h) rejection",
    "pwh_reclaim": "Prior-week high hold",
    "pwl_reclaim": "Prior-week low hold",
    "pmh_reclaim": "Prior-month high hold",
    "pml_reclaim": "Prior-month low hold",
    "pqh_reclaim": "Prior-quarter high hold",
    "pql_reclaim": "Prior-quarter low hold",
    "swing_reclaim_pwh": "Prior-week high hold (2h)",
    "swing_reclaim_pwl": "Prior-week low hold (2h)",
    "swing_reclaim_pmh": "Prior-month high hold (2h)",
    "swing_reclaim_pml": "Prior-month low hold (2h)",
    "swing_reclaim_pqh": "Prior-quarter high hold (2h)",
    "swing_reclaim_pql": "Prior-quarter low hold (2h)",
    "rsi_30_35": "RSI 30-35 oversold turn",
    "pdh_retest_hold": "PDH retest hold",
    "pwh_breakout_retest": "Prior-week high breakout-retest",
    "pmh_breakout_retest": "Prior-month high breakout-retest",
    "prior_day_low_reclaim": "Prior-day low reclaim",
    "prior_day_high_breakout": "Prior-day high breakout",
